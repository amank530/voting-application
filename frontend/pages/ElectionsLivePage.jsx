        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-xs p-6 flex flex-col justify-between">
          <div>
            ...
            <p className="text-[11px] text-gray-400 mb-6">
              Total registered voter size vs estimated physical polling booth capacity per state area.
            </p>
          </div>
          ...
          <div className="h-72 text-xs font-mono">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={INDIAN_REGIONS.map(reg => ({
                ...
                'Booths (Hundreds)': reg.districts.length * 1.8
                ...
                <Bar dataKey="Booths (Hundreds)" fill="#f59e0b" radius={[4, 4, 0, 0]} name="Booths (Hundreds)" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
